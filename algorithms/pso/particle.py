...
class Particle:
    def __init__(self, dimension: int, fitness_func: Callable[[np.ndarray], float]):
        """
        ...
        # Position initialized to a random value between accepted bounds
    ...
    def evaluate_fitness(self, fitness_func: Callable[[np.ndarray], float]):
        ...
        # Update best fitness and best position
